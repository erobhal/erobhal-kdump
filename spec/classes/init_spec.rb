...
describe 'kdump' do
  ...
  platforms.sort.each do |k,v|
    describe "on #{k} with memory >= 2048 MB" do
      let(:facts) { {
...
core_collector makedumpfile -d 17 -c
  ...
  describe 'not on supported OS' do
    let(:facts) { {
    ...
    it 'should fail' do
      ...
      }.to raise_error(Puppet::Error,/module supports RedHat 7 and CentOS 7, you are running WrongOS 0/)
    end
  end
end
